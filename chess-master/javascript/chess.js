...
const TILE_SIZE = 110;
const WHITE_TILE_COLOR = "#fff";
const BLACK_TILE_COLOR = "#000";
const HIGHLIGHT_COLOR = "#aaff00";
const WHITE = 0;
const BLACK = 1;
...
function startGame() {    
    ...
    currentTeam = WHITE;
    currentTeamText.textContent = "Oqning navbati";
...
function changeCurrentTeam() {
    if (currentTeam === WHITE) {
        currentTeamText.textContent = "Qora taraf";
        currentTeam = BLACK;
    } else {
        currentTeamText.textContent = "Oq taraf";
        currentTeam = WHITE;
    }
}
...
function updateCasualities(casualities, text) {
    ...
    if (none) text.textContent = "Yutqazilmagan";
}

function updateTotalVictories() {
    totalVictoriesText.textContent = "Yutilgan o'yin: oq " + whiteVictories + " - qora " + blackVictories;
}
